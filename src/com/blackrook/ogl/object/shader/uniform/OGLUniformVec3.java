...
/**
 * A shader uniform three-component vector type. 
 * @author Matthew Tropiano
 */
public class OGLUniformVec3 extends OGLUniform
{
	/** The uniform's value. */
	private float[] value;
	 ...
	 */
	public OGLUniformVec3(String name)
	{
		this(name, 0, 0, 0);
	}
	 ...
	 */
	public OGLUniformVec3(String name, float valueX, float valueY, float valueZ)
	{
		super(name);
		value = new float[3];
		setValue(valueX, valueY, valueZ);
	}
	...
	{
		if (valueX != value[0] || valueY != value[1] || valueZ != value[2])
		{
			value[0] = valueX;
			value[1] = valueY;
			value[2] = valueZ;
	...
	{
		g.getGL().glUniform3fvARB(getUniformLocation(g, shader),1,value,0);
	}
